...
var layout : Array = [
	...
	# —— 阶段2：旋转环廊（安全网与圆盘错开 100px；Step2/Step3/Transition 已移除，
	#    由 Main.tscn 中条件平台 Step2_Conditional/Step3_Conditional/Transition_Conditional 代替）——
	[7900.0, 640.0, 900.0],   # RingGround（安全网，x7450..8350，顶625）
	[7900.0, 540.0, 600.0],   # CorePlatform（圆盘，顶525；跳上后切换参考系）
	[7900.0, 150.0, 400.0],   # Step1（旋转圆盘上部，顶135；右接阶段2 迷宫顶入口）
]
